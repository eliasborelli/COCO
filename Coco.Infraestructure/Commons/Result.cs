...
namespace Coco.Infraestructure.Commons
{
    public class Result
    {
        ...
        /// <summary>
        /// Create a failed <see cref="Result{TResult}"/> with the given error message an data returned for particular case
        /// </summary>
        /// <typeparam name="TResult">Type of value</typeparam>
        /// <typeparam name="TResult">Tipo de <paramref name="value"/>Type of value</typeparam>
        /// <param name="errors">Errors</param>
        /// <returns>Failed Result</returns>
        public static Result<TResult> Failed<TResult>(TResult value, params string[] errors) =>
            new Result<TResult>(errors);
    ...
    public class Result<TResult> : Result
    {
        ...
        //For the particular case of returning data in a failed scenario
        protected internal Result(TResult result, IEnumerable<string> errors)
            : base(false, errors)
        {
        }
